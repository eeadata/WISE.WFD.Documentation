...
DOCS_ROOT = "ProtectedArea"           # created automatically if it doesn't exist yet
...
# paths (leading "/") so nested includes (WFDProtectedArea.md -> section
...
SOURCE_ROOT_PREFIX = "/TestingPhase/ProtectedArea/QualityControl"
...
QC_FILES_DIR = "ProtectedArea/QC files"
