...
• about the physical volumes of water, the revenues and the costs ({ref}`Figure 5 <Figure 5>`),  
• for three water user sectors – agriculture, industry and households ({numref}`EconomicAnalysis_WaterSectors_4th_cycle _Table`),  
